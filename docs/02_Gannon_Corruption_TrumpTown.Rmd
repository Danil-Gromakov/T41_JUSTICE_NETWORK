...
df <- df %>% dplyr::select(person, position_current, employer_trump_tie, employer_ally_tie) %>%
  dplyr::distinct() %>%
  dplyr::rename(trump_employment = employer_trump_tie, trump_personal = employer_ally_tie)

df$trump_past_employ
