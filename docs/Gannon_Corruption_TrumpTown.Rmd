...
memb_upset <- memb %>% dplyr::select(federalist_society, heritage_foundation) %>%
...
UpSetR::upset(memb_upset,
      ...
      mainbar.y.label = "Number of Prosecutors", order.by = "freq", empty.intersections = "on")
```
...
googlesheets4::write_sheet(memb_clean, ss = "https://docs.google.com/spreadsheets/d/1hPOBOyTujUReQzpjZ9PqIhj23V5C74EygMnmXIi6BgI/edit?usp=sharing",
                           sheet = "membershipjusticedepartment_noedit")

memb <- write.csv(memb_clean, paste0(here::here(), "/TrumpProsecutors_network/", "justicedepartment_membership_hist.csv"))
