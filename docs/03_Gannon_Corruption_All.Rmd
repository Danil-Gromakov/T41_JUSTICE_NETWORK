...
df_noemploy <- df_noemploy %>% dplyr::select("person", "position_current", "source",
                ...
                "bachelors", "masters", "doctorate", "law", "law_conservative_score", "law_rank",
                "barr_appointment", "political_affiliation", 
                "connection_trump", "connection_trump_interviews", "connection_trump_campaign",
                "connection_trumpally", "connection_trumpally_innercircle", "connection_trumpally_wh_counsel", "connection_trumpally_us_senate", "connection_trumpally_state_gov",
                ...
                "connection_careerprofessional",
                "connection_other",
                "american_center_for_law_and_justice", "christian_legal_society_bar_association", "federalist_society", "heritage_foundation", "national_rifle_association_tie", "republican_national_lawyers_association_tie")

# Fix NAs that should be 0's
df_noemploy[c("connection_trump", "connection_trump_interviews", "connection_trump_campaign", "connection_trumpally", "connection_trumpally_innercircle", "connection_trumpally_wh_counsel", "connection_trumpally_us_senate", "connection_trumpally_state_gov", "connection_conservative_all", "connection_conservative_lawschool", "connection_conservative_firm", "connection_conservative_group", "connection_conservative_gov", "connection_careerprofessional", "connection_other")][is.na(df_noemploy[c("connection_trump", "connection_trump_interviews", "connection_trump_campaign", "connection_trumpally", "connection_trumpally_innercircle", "connection_trumpally_wh_counsel", "connection_trumpally_us_senate", "connection_trumpally_state_gov", "connection_conservative_all", "connection_conservative_lawschool", "connection_conservative_firm", "connection_conservative_group", "connection_conservative_gov", "connection_careerprofessional", "connection_other")])] <- 0
```
